...
rover_pub = rospy.Publisher('/RosAria/cmd_vel', Twist, queue_size=10)# indicadores de velocidad del rover
...
def callback(ros_data):
    ...
    rover_pub.publish(vel_msg)# se utilizo lo mismo que el drone, solo sigue al drone, son un solo movimiento.
